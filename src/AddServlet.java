...
public class AddServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		out.println("社員番号：<input type=\"text\" name=\"addempno\" size=\"20\" value=\"" + empno + "\"><br><br>");
		out.println("氏：<input type=\"text\" name=\"addlname\" size=\"20\" value=\"" + lname + "\"><br><br>");
		out.println("名：<input type=\"text\" name=\"addfname\" size=\"20\" value=\"" + fname + "\"><br><br>");
		out.println("氏（カナ）：<input type=\"text\" name=\"addlkana\" size=\"20\" value=\"" + lkana + "\"><br><br>");
		out.println("名（カナ）：<input type=\"text\" name=\"addfkana\" size=\"20\" value=\"" + fkana + "\"><br><br>");
		out.println(
				"パスワード：<input type=\"password\" name=\"addpassword\" size=\"20\" value=\"" + password + "\"><br><br>");
